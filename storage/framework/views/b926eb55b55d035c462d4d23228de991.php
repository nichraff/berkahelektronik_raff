            ...
            <div id="bannerCarousel" class="carousel slide" data-bs-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="<?php echo e(asset('images/Banner Promo/1.jpg')); ?>" class="d-block w-100" alt="slide 1">
                    </div>
                    <div class="carousel-item">
                        <img src="<?php echo e(asset('images/Banner Promo/2.jpg')); ?>" class="d-block w-100" alt="slide 2">
                    </div>
                    <div class="carousel-item">
                        <img src="<?php echo e(asset('images/Banner Promo/3.jpg')); ?>" class="d-block w-100" alt="slide 3">
                    </div>
                    <div class="carousel-item">
                        <img src="<?php echo e(asset('images/Banner Promo/4.jpg')); ?>" class="d-block w-100" alt="slide 4">
                    </div>
                    <div class="carousel-item">
                        <img src="<?php echo e(asset('images/Banner Promo/5.jpg')); ?>" class="d-block w-100" alt="slide 5">
                    </div>
                    <div class="carousel-item">
                        <img src="<?php echo e(asset('images/Banner Promo/6.jpg')); ?>" class="d-block w-100" alt="slide 6">
                    </div>
                </div>
            ...
            <section class="container py-3">
                ...
                <div class="row row-compact">
                    ...
                    <div class="col-card-compact">
                        <a href="<?php echo e(route('products.show', $product->id)); ?>" class="product-card-compact">
                                ...
                                <?php if($product->diskon > 0): ?>
                                    <div class="badge-above-image">
                                        <div class="badge-sale-percent">
                                            ...
                                            <span class="percent-number"><?php echo e($product->diskon); ?>%</span>
                                        </div>
                                    </div>
                                <?php else: ?>
                            ...
                            <div class="product-price-compact">
                                ...
                                <span class="current-price-compact <?php if($product->diskon > 0): ?> current-price-discount <?php endif; ?>">
                    ...
                    <div class="col-12 text-center py-4">
                        ...
                        <a href="<?php echo e(route('products.create')); ?>" class="btn btn-sm btn-primary" style="font-size: 12px; padding: 4px 12px;">
                            Tambah Produk
                        </a>
                    </div>
                    <?php endif; ?>
...
</html><?php /**PATH C:\laragon\www\TokoBerkahElektronik\berkahelektronik_raff\resources\views/customers/dashboard/index.blade.php ENDPATH**/ ?>